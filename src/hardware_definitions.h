...
typedef enum {
    LOAD_SENSOR_R_ACTIVE_LED        = 21,
    LOAD_SENSOR_L_ACTIVE_LED        = 16,
...
typedef enum {
    LOAD_SENSOR_R_JACK_DETECT_PIN       = 1,
    LOAD_SENSOR_L_JACK_DETECT_PIN       = 4,
    TEMP_SENSOR_R_JACK_DETECT_PIN       = 2,
    TEMP_SENSOR_L_JACK_DETECT_PIN       = 3,
    MOISTURE_SENSOR_R_JACK_DETECT_PIN   = 0,
    MOISTURE_SENSOR_L_JACK_DETECT_PIN   = 5
...
static const uint8_t LOAD_SENSOR_SDA_R                  = 28;
static const uint8_t LOAD_SENSOR_SCL_R                  = 27;
static const uint8_t LOAD_SENSOR_SDA_L                  = 26;
static const uint8_t LOAD_SENSOR_SCL_L                  = 22;

// Load sensor control pins (input)
static const uint8_t LOAD_SENSOR_TARE_R                 = 10;
static const uint8_t LOAD_SENSOR_TARE_L                 = 11;

// Temperature sensor pins (input/output)
static const uint8_t TEMP_SENSOR_R_CTL                  = 14;
static const uint8_t TEMP_SENSOR_L_CTL                  = 15;
